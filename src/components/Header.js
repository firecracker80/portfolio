...
class Header extends Component {
  ...
  render() {
    if (this.props.sharedData) {
      ...
      this.titles = "USAR Veteran | Software Developer | CEO of my Web Design Agency"
      // this.props.sharedData.titles; //...map(x => [ x.toUpperCase(), 1500 ] ).flat();
    }
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/firecracker80" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
